    ...
    setTimeout(() => {
      if (account) {
        ...
        if (typeof window !== "undefined") {
          localStorage.setItem("co-synapse-user", JSON.stringify({ name: account.name, email: account.email }));
        }
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="newspaper-label mt-1">Established 2026</p>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="space-y-1.5">
            <Label htmlFor="email" className="newspaper-label">
              Email
            </Label>
            <Input
              id="email"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="password" className="newspaper-label">
              Password
            </Label>
            <Input
              id="password"
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="newspaper-label">or</span>
          <Separator className="flex-1" />
        </div>
